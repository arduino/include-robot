...
console.log(`Copying file [${path.resolve(__dirname, "../scratch-gui/src/components/dismissable-banner/")}] to file [${path.resolve(__dirname, "../../scratch-gui/src/components/dismissable-banner/")}]`);

fs.cpSync(path.resolve(__dirname, "../scratch-gui/src/components/dismissable-banner/"), path.resolve(__dirname, "../../scratch-gui/src/components/dismissable-banner/"), {recursive: true});
