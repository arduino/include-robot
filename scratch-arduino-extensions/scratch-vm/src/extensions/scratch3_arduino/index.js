...
const calcAngelByAxis = (mainAxis, axis1, axis2) => {
  ...
  return roundToDecimalPlaces(
    (Math.atan(mainAxis / Math.sqrt(axis1Square + axis2Square)) * 180) /
      Math.PI,
  );
};
      ...
      blocks: [
        ...
        },
        {
          ...
          text: formatMessage({
            ...
            description:
              "go forward for a given amount of seconds (max 10 seconds).",
          }),
          arguments: {
            SECONDS: {
              type: ArgumentType.NUMBER,
        ...
        },
        {
          ...
          text: formatMessage({
            ...
            description:
              "go backward for a given amount of seconds (max 10 seconds).",
          }),
          arguments: {
            SECONDS: {
              type: ArgumentType.NUMBER,
...
class Scratch3Arduino {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: formatMessage({
            ...
            default:
              "Set the analog output of the analog pin [ANALOG_PINS] as [ANALOG_VALUE]",
        ...
        },
        {
          ...
          text: formatMessage({
            ...
            default:
              "Set the servo motor angle on pin [DIGITAL_PINS] to [DEGREES_ROTATION] °",
        ...
        // get magnetic field value
        {
          ...
          text: formatMessage({
            ...
            default:
              "Measure the magnetic field over the [SENSOR_3D_AXIS] axis in [MAGNETIC_UNIT]",
  ...
  _isTilted(direction) {
    ...
    return (
      this._getAccelerationByDirection(direction, acceleration) >=
      Scratch3Arduino.TILT_THRESHOLD
    );
  }
  ...
  _getAccelerationByDirection(direction, acceleration) {
    switch (direction) {
      ...
      default:
        log.warn(
          `Unknown tilt direction in _getAccelerationByDirection: ${direction}`,
        );
    }
